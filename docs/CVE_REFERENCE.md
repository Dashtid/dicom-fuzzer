...
| CVE ID         | Product    | Type                   | CVSS | Fixed In   |
| -------------- | ---------- | ---------------------- | ---- | ---------- |
| CVE-2025-5943  | MicroDicom | OOB write              | 8.8  | 2025.3     |
| CVE-2025-11266 | GDCM       | PixelData OOB write    | 6.6  | 3.2.2      |
| CVE-2025-53618 | GDCM       | JPEG codec OOB read    | 7.5  | 3.0.24     |
| CVE-2025-53619 | GDCM       | JPEG info disclosure   | 7.5  | 3.0.24     |
| CVE-2025-1001  | RadiAnt    | TLS cert bypass (MitM) | 5.7  | 2025.1     |
| CVE-2024-22100 | MicroDicom | Heap overflow          | 7.8  | 2024.1     |
| CVE-2024-28877 | MicroDicom | Stack overflow         | 8.7  | 2024.2     |
| CVE-2024-33606 | MicroDicom | URL scheme auth bypass | 8.8  | 2024.2     |
| CVE-2022-2119  | DCMTK      | Path traversal (SCP)   | 7.5  | 3.6.7      |
| CVE-2022-2120  | DCMTK      | Path traversal (SCU)   | 7.5  | 3.6.7      |
| CVE-2022-2121  | DCMTK      | Null pointer deref     | 6.5  | 3.6.7      |
| CVE-2019-11687 | DICOM Std  | Preamble executable    | N/A  | Mitigation |
