...
Phase 3 of the stack-trace capture work. Phase 1 captures the minidump
(``--dump-tool`` / ProcDump); Phase 2 turns it into structured frames
(``dump_analyzer.analyze_dump``); this module turns those frames into a
