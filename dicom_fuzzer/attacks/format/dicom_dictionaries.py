...
# =============================================================================
# CS (Code String) VR Tag Dictionaries
# =============================================================================

# Image Type (0008,0008) - CS VR, VM 2-n
IMAGE_TYPES = [
    "ORIGINAL\\PRIMARY",
    "DERIVED\\SECONDARY",
    ...
    "",
    "A" * 20,
    "ORIGINAL",  # Missing required second value
]

# Body Part Examined (0018,0015) - CS VR
BODY_PARTS = [
    "HEAD",
    "CHEST",
    "ABDOMEN",
    ...
    "",
    "A" * 20,
    "head",  # Wrong case (CS must be uppercase)
]

# Laterality (0020,0060) - CS VR
LATERALITY_VALUES = [
    "L",  # Left
    "R",  # Right
    # Edge cases
    "B",  # Both (not valid for this tag)
    "LEFT",  # Wrong format
    "",
    "X",
]

# Patient Position (0018,5100) - CS VR
PATIENT_POSITIONS = [
...
# Conversion Type (0008,0064) - CS VR
CONVERSION_TYPES = [
    "DV",  # Digitized Video
    ...
    "SI",  # Scanned Image
    "DRW",  # Drawing
    "SYN",  # Synthesized Image
    # Edge cases
    "INVALID",
    "",
]

# Presentation Intent Type (0008,0068) - CS VR
PRESENTATION_INTENT_TYPES = [
    "FOR PROCESSING",
    "FOR PRESENTATION",
    # Edge cases
    "INVALID",
    "",
    "for processing",  # Wrong case
]

# Lossy Image Compression (0028,2110) - CS VR
LOSSY_COMPRESSION_VALUES = [
    "00",  # Not lossy
    "01",  # Lossy
    # Edge cases
    "1",  # Wrong format (should be 2 chars)
    "02",  # Invalid
    "",
    "YES",  # Wrong format
]

# Patient Orientation (0020,0020) - CS VR
...
# Image Laterality (0020,0062) - CS VR (similar to Laterality but for image)
IMAGE_LATERALITY_VALUES = [
    "R",  # Right
    "L",  # Left
    "U",  # Unpaired
    "B",  # Both
...
class DICOMDictionaries:
    ...
    ALL_DICTIONARIES: dict[str, list[str]] = {
        ...
        "presentation_intent_types": PRESENTATION_INTENT_TYPES,
        "lossy_compression": LOSSY_COMPRESSION_VALUES,
        "patient_orientations": PATIENT_ORIENTATIONS,
        "image_laterality": IMAGE_LATERALITY_VALUES,
    }
