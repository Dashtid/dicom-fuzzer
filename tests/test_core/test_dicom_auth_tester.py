...
from dicom_fuzzer.strategies.robustness.network.tls.auth import DICOMAuthTester
...
class TestDICOMAuthTester:
    ...
    @patch("dicom_fuzzer.strategies.robustness.network.tls.auth.socket.socket")
...
class TestBackwardCompatibility:
    ...
    def test_imports_from_dicom_tls_fuzzer(self) -> None:
        ...
        from dicom_fuzzer.strategies.robustness.network.tls.fuzzer import DICOMAuthTester as Tester
