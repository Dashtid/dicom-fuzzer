...
class TestDetectSeries:
    ...
    @patch("dicom_fuzzer.core.dicom.series_detector.pydicom.dcmread")
...
class TestDetectSeriesInDirectory:
    ...
    @patch("dicom_fuzzer.core.dicom.series_detector.SeriesDetector._find_dicom_files")
    @patch("dicom_fuzzer.core.dicom.series_detector.SeriesDetector.detect_series")
...
class TestEdgeCasesAndExceptionPaths:
    ...
    @patch(
        "dicom_fuzzer.core.dicom.series_detector.SeriesDetector.detect_series_in_directory"
    )
    ...
    @patch("dicom_fuzzer.core.dicom.series_detector.SeriesDetector._is_dicom_file")
